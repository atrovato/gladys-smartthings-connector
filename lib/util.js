...
module.exports = {
  ...
  /**
   * Gets the OAuth client id/secret.
   */
  getOAuthCredentials: function () {
    return gladys.param.getValue(shared.smtOAuthCredentialsParam)
      .then((value) => {
        return JSON.parse(value);
      }).catch(() => {
        return Promise.reject('SmartThings OAuth credentials not stored');
      });
  }
};